...
{
    public BeeMovement movement;  //could be acquired through the hierarchy, but that might change
    ...
    void Update()
    {
        ...
        //rapidly decay it's physics velocity in any case?
        body.velocity *= 0.9f;
